...
public class DfResourceUtil {
    ...
    public static void makeFileAndClose(URL url, String outputFilename) {
        ...
        try {
            ...
            String msg = toClassTitle(url) + "#openStream() threw the IO exception!";
            throw new IllegalStateException(msg, e);
        }
    ...
    public static void makeFileAndClose(InputStream in, String outputFilename) {
        ...
        try {
            ...
            String msg = "new FileOutputStream(outputFile, false) threw the " + toClassTitle(e);
        ...
        try {
            ...
            String msg = "fileOutputStream.write(toBytes) threw the " + toClassTitle(e);
            msg = msg + ": outputFilename=" + outputFilename;
            throw new IllegalStateException(msg, e);
        } finally {
            try {
     ...
     */
    protected static String toClassTitle(Object obj) {
        if (obj == null) {
            return null;
        }
        final String fqcn;
